...
def checklist_model(model: TradingModel, ticker: str, trading_freq: int):
    ...
    long_term_series, topic_long_term_topic_delta = get_trend_series(
        data=model.market_data.history[long_term_topic],
        entry_bar=entry_bar,
        ref_column='close')
    ...
    abrupt_blue, large_curvature = get_abrupt(data=sma_8, n=5, threshold=2.0)
