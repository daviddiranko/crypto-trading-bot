    ...
    if (entry_bar.name > model.model_storage['entry_bar_time']
        ...
        if len(lows_trend_15) > 1 and not highs_trend_15.empty:
            ...
            if lows_trend_15.iloc[-1] > lows_trend_15.iloc[-2]:
                ...
                add_model_stats(model=model, long=True, ts=ts, key='1.1.1', value=0)
        ...
        #     export = {}
        #     export['1.1.1'] = lows_trend_15.iloc[-1] > lows_trend_15.iloc[-2]
        #     export['1.1.2'] = lows_trend_5.iloc[-1] > lows_trend_5.iloc[-2]
        #     export['1.9'] = sma_24[-1] < entry_bar['close']
        #     export['1.10.1'] = True
        #     export['1.12.2'] = True
        #     export['1.12.8'] = True
        #     export['1.12.9'] = True
